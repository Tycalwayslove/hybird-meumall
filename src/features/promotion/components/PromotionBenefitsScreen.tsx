...
export function PromotionBenefitsScreen({ data }: { data: PromotionBenefitsData }) {
  ...
  return (
    <PromotionShell style={{ background: benefitsTheme.pageBackground }}>
      <section className="relative min-h-[432px] overflow-hidden px-4 text-text-inverse" style={{ background: theme.heroGradient }}>
        <div className="absolute inset-0" style={{ background: benefitsTheme.heroHighlight }} />
        <PromotionNav light title="权益中心" trailing={<span className="text-[14px] leading-[22px] text-text-inverse">权益规则</span>} />
