import { fetchSeckillProductsData } from "@/features/seckill/server/seckill-real-service";
...
export async function GET(request: Request) {
  try {
    ...
    console.error("[h5-bff-route-error]", {
      message: error instanceof Error ? error.message : "Seckill products BFF request failed.",
      requestId,
      route: "/api/bff/seckill/products"
    });
