import { fetchWalletOrdersData, type WalletState } from "@/features/mine-secondary/server/wallet-real-service";
...
export async function GET(request: Request) {
  ...
  const result = await fetchWalletOrdersData({
    ...
    promotionOrderUserId: context.auth.userInfo?.phone ?? null,
