import { fetchRegisterAesKey } from "@/features/register/server/register-service";
...
export async function GET(request: Request) {
  try {
    ...
    const result = await fetchRegisterAesKey({
    ...
    return routeErrorResponse(request, error, "/api/bff/register/aes-key", "Register AES key BFF request failed.");
  }
}
