import { fetchCategoryListData } from "@/features/category/server/category-real-service";
...
export async function GET(request: Request) {
  try {
    ...
    console.error("[h5-bff-route-error]", {
      message: error instanceof Error ? error.message : "Category list BFF request failed.",
      requestId,
      route: "/api/bff/category/list"
    });
